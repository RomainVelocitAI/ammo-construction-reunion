...
const amenagementSections: SectionData[] = [
  {
    text: "Création de Votre Paradis Tropical",
    img: "/amenagement exterieur.png"
  },
  {
    text: "Jardins et Piscines de Luxe",
    img: "/lodgedeluxe.png"
  },
  {
    text: "Espaces Extérieurs d'Exception",
    img: "/exterieur.jpg"
  }
];

const AnimatedSectionsAmenagement: React.FC = () => {
  ...
  const sections = amenagementSections;
...
export default AnimatedSectionsAmenagement;