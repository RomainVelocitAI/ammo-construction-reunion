...
const promoteursSections: SectionData[] = [
  {
    text: "Lotissements Écolodge Rentables",
    img: "/lodgedeluxe.png"
  },
  {
    text: "Immeubles de Rapport Modernes",
    img: "/villamoderne.png"
  },
  {
    text: "Expertise Technique et Financière",
    img: "/construction.jpg"
  }
];

const AnimatedSectionsPromoteurs: React.FC = () => {
  ...
  const sections = promoteursSections;
...
export default AnimatedSectionsPromoteurs;
