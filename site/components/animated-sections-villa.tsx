...
const villaSections: SectionData[] = [
  {
    text: "Architecture Contemporaine d'Exception",
    img: "/villamoderne.png"
  },
  {
    text: "Espaces de Vie Lumineux et Ouverts",
    img: "/villa.png"
  },
  {
    text: "Design Tropical Moderne",
    img: "/construction.jpg"
  }
];

const AnimatedSectionsVilla: React.FC = () => {
...
export default AnimatedSectionsVilla;