...
const extensionSections: SectionData[] = [
  {
    text: "Agrandissement Harmonieux de votre Habitat",
    img: "/extension.png"
  },
  {
    text: "Intégration Architecturale Parfaite",
    img: "/villa.png"
  },
  {
    text: "Espaces Supplémentaires Sur-Mesure",
    img: "/construction.jpg"
  }
];

const AnimatedSectionsExtension: React.FC = () => {
  ...
  const sections = extensionSections;
...
export default AnimatedSectionsExtension;