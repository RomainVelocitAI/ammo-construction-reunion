...
const containerSections: SectionData[] = [
  {
    text: "Innovation Architecturale Modulaire",
    img: "/maison_contener.png"
  },
  {
  ...
  {
    text: "Design Industriel Personnalisé",
    img: "/villamoderne.png"
  }
];

const AnimatedSectionsContainer: React.FC = () => {
  ...
  const sections = containerSections;
...
export default AnimatedSectionsContainer;