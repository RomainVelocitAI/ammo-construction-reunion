...
const lodgeSections: SectionData[] = [
  {
    text: "Lodges de Prestige en Harmonie avec la Nature",
    img: "/lodgedeluxe.png"
  },
  {
    text: "Hébergements Touristiques Haut de Gamme",
    img: "/exterieur.jpg"
  },
  {
    text: "Rentabilité et Durabilité Réunies",
    img: "/construction.jpg"
  }
];

const AnimatedSectionsLodge: React.FC = () => {
...
export default AnimatedSectionsLodge;