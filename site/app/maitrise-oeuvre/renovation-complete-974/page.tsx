              ...
              <div className="bg-background rounded-2xl p-8 shadow-lg mb-12">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                  <div className="text-center p-6 bg-secondary/10 rounded-xl">
                    ...
                    <p className="text-muted-foreground">Selection et pilotage de tous les corps de metier pour votre renovation</p>
                  </div>
                  <div className="text-center p-6 bg-secondary/10 rounded-xl">
                    <h3 className="text-xl font-bold text-foreground mb-3">Suivi Budget & Delais</h3>
                    <p className="text-muted-foreground">Maitrise des couts et respect du planning etabli</p>
                  </div>
                  <div className="text-center p-6 bg-secondary/10 rounded-xl">
                    <h3 className="text-xl font-bold text-foreground mb-3">Mise aux Normes</h3>
                    <p className="text-muted-foreground">Conformite RE2020 et reglementations locales</p>
                  </div>
                </div>
              </div>
