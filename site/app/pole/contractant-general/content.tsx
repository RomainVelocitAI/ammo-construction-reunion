...
export default function ContractantGeneralContent() {
  return (
      ...
      <section className="relative min-h-[85vh] flex items-end overflow-hidden pt-24 sm:pt-28 lg:pt-36">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Contractant Général - Rénovation et gros œuvre à La Réunion"
            fill
        ...
        <div className="relative z-10 container mx-auto px-6 sm:px-12 lg:px-20 pb-16 sm:pb-20 lg:pb-28">
          <div className="max-w-4xl">
            ...
            >
              Le Groupe AMMO coordonne l'ensemble des corps de métier pour vos projets de construction, rénovation et extension. Un seul interlocuteur du premier coup de pioche à la remise des clés.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            >
              <div className="relative">
                ...
                <Image
                  ...
                  alt="Interlocuteur unique Contractant Général"
                  width={600}
                  height={500}
            ...
            >
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  ...
                  { value: 'DTU', label: 'Normes respectées' },
      ...
      <section className="py-20 sm:py-28 bg-gradient-to-br from-amber-50 to-yellow-50 relative overflow-hidden">
        ...
        >
          ...
          <p className="font-body text-base sm:text-lg text-[#605E5B] max-w-2xl mx-auto mb-10">
            Rénovation, construction ou aménagement — discutons ensemble de votre projet. Notre équipe Contractant Général est prête à vous accompagner.
          </p>
          <Link
            href="/#contact"
