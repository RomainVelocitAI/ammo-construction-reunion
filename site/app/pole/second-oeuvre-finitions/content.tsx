...
import { TreePine, Home, ShieldCheck, PanelTop, Warehouse, Flower2, Waves } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#F2ECE7]">
      ...
      {/* ══════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════ */}
      <section id="services" className="py-12 sm:py-16 lg:py-24 bg-[#F2ECE7] overflow-x-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              >
                <div className="relative group">
                  ...
                  <div className="relative w-72 h-80 sm:w-80 sm:h-96 rounded-2xl shadow-2xl overflow-hidden">
                    <Image
                      src="/pdp-steve.png"
                      alt="Steve Lesgardeur"
                      fill
                      className="object-cover"
                    />
                  </div>
      ...
      {/* ══════════════════════════════════════════════
          ENTRETIEN JARDINS & PISCINES
          ══════════════════════════════════════════════ */}
      <section className="py-12 sm:py-16 lg:py-24 bg-[#F2ECE7]">
        <div className="container mx-auto px-6 sm:px-12 lg:px-20">
          <motion.div className="text-center mb-12 sm:mb-16" {...fadeInUp}>
            ...
            <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-foreground tracking-tight mb-6">
              Jardins &
              <span className="bg-gradient-to-r from-[#BD9C69] to-[#D6B363] bg-clip-text text-transparent"> Piscines</span>
            </h2>
            <p className="font-body text-lg text-[#605E5B] max-w-2xl mx-auto">
              Un service complet d'entretien pour préserver la beauté et la fonctionnalité de vos espaces extérieurs.
            </p>
          </motion.div>

          <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto" {...staggerContainer}>
            <motion.div className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 p-8" {...staggerItem}>
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#BD9C69]/10 to-[#D6B363]/10 border border-[#BD9C69]/20 flex items-center justify-center mb-6 group-hover:from-[#BD9C69] group-hover:to-[#D6B363] transition-all duration-500">
                <Flower2 className="w-7 h-7 text-[#BD9C69] group-hover:text-white transition-colors duration-500" />
              </div>
              <h3 className="font-heading text-xl sm:text-2xl text-foreground mb-3 tracking-tight">Entretien de Jardins</h3>
              <p className="font-body text-sm sm:text-base text-[#605E5B] leading-relaxed">
                Tonte, taille, élagage, désherbage et entretien des espaces verts. Nous prenons soin de vos jardins pour qu'ils restent un écrin de verdure toute l'année.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-[3px] bg-gradient-to-r from-[#BD9C69] to-[#D6B363] group-hover:w-full transition-all duration-500" />
            </motion.div>
            ...
            <motion.div className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 p-8" {...staggerItem}>
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#BD9C69]/10 to-[#D6B363]/10 border border-[#BD9C69]/20 flex items-center justify-center mb-6 group-hover:from-[#BD9C69] group-hover:to-[#D6B363] transition-all duration-500">
                <Waves className="w-7 h-7 text-[#BD9C69] group-hover:text-white transition-colors duration-500" />
              </div>
              <h3 className="font-heading text-xl sm:text-2xl text-foreground mb-3 tracking-tight">Entretien de Piscines</h3>
              <p className="font-body text-sm sm:text-base text-[#605E5B] leading-relaxed">
                Traitement de l'eau, nettoyage, vérification des équipements et maintenance régulière. Votre piscine propre et prête à l'emploi en toute saison.
              </p>
              <div className="absolute bottom-0 left-0 w-0 h-[3px] bg-gradient-to-r from-[#BD9C69] to-[#D6B363] group-hover:w-full transition-all duration-500" />
            </motion.div>
          </motion.div>
