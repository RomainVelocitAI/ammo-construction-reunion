      ...
      <main className="min-h-screen bg-background pt-24 sm:pt-28 lg:pt-36 xl:pt-44">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                >
                  ...
                  >
                    <h3 className="text-xl font-bold text-foreground mb-4">Vision pour un bâtiment durable</h3>
              ...
              <div className="flex flex-col lg:flex-row-reverse items-center gap-12">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="mt-8 bg-gradient-to-br from-amber-50 to-yellow-50 p-6 rounded-xl border border-amber-200 hover:border-amber-300 hover:shadow-lg transition-all duration-300"
                  >
                    <h3 className="text-xl font-bold text-foreground mb-4">Engagement pour un bâtiment responsable</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start hover:translate-x-2 transition-transform duration-300">
                        <span className="text-accent mr-2 mt-1">•</span>
        ...
        <section className="py-20 bg-gradient-to-br from-amber-50 to-yellow-50">
          ...
          >
            ...
            <a
              href="/#contact"
              className="inline-block px-8 py-4 bg-gradient-to-r from-amber-500 to-yellow-500 text-primary-foreground font-bold text-lg rounded-full hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
